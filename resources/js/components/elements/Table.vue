                    ...
                    <tr v-for="(arr, tr) in lsitaFiltrada" :key="lsitaFiltrada[tr].id">
                        ...
                        <td style="width: 1rem;">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <buttonComponent v-if="permissoes.u" label="Atualizar" type="primary" @click="Update(arr['id'])"></buttonComponent>
                                <buttonComponent v-if="permissoes.r" label="Vizualizar" type="warning" @click="Read(arr['id'])"></buttonComponent>
